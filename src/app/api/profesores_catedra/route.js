...
FROM historico h
WHERE anno = (SELECT MAX(año) FROM periodos) AND per = (SELECT semestre FROM periodos WHERE año = ( SELECT MAX(año) FROM periodos) ORDER BY semestre DESC LIMIT 1) AND trim(tipo_docente)!='Planta'
